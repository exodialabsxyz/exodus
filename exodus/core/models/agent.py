...
class AgentDefinition:
    ...
    handoffs: List[str] = field(default_factory=list)  ### List of agent names this agent can transfer to
    ...
    def from_toml(cls, file: Path) -> "AgentDefinition":
        ...
        llm_config = LLMConfig(
            ...
            custom_api_base=llm_data.get("custom_api_base", settings.get("llm.custom_api_base", None))
        )
